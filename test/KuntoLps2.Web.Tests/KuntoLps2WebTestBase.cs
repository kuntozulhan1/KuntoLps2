...
{
    public abstract class KuntoLps2WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static KuntoLps2WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(KuntoLps2WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<KuntoLps2DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<KuntoLps2DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<KuntoLps2DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<KuntoLps2DbContext, Task<T>> func)
        {
            T result;
